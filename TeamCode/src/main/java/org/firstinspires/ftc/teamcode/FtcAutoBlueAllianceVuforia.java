...
@Autonomous(name="FtcAutoBlueAllianceVuforia" , group = "FTC")
@Disabled
public class FtcAutoBlueAllianceVuforia extends  LinearOpMode{
...
//                .multiplied(Orientation.getRotationMatrix(EXTRINSIC, XYZ, DEGREES, 90, 0, -90)));
        ...
        move_with_pid(left_back_motor,left_front_motor,right_back_motor,right_front_motor,18,move_power,false);
                ...
                if (((VuforiaTrackableDefaultListener) trackable.getListener()).isVisible()) {
                    ...
                    if (target_name == "Stone Target"){
                        ...
                        if(num_of_trials  == 0){
                            ...
                            move_side_with_pid(left_back_motor,left_front_motor,right_back_motor,right_front_motor,4,side_power, false);
                            ...
                            move_side_with_pid(left_back_motor,left_front_motor,right_back_motor,right_front_motor,5,side_power, false);

                        }

                        move_with_pid(left_back_motor,left_front_motor,right_back_motor,right_front_motor,6,move_power,false);
...
//
//                                    if (num_of_trials == 1) {
//                                        move_side_with_pid(left_back_motor, left_front_motor, right_back_motor, right_front_motor, 7, side_power, false);
//
//                                    } else {
